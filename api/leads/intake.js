...
import { getUserFromToken, getUserClient, getServiceClient } from '../../lib/supabaseServer.js';
...
export default async function handler(req, res) {
  ...
  try {
    ...
    if (profile.webhook_url) {
      // Fire and forget
      fireUniversalWebhook(profile.webhook_url, 'lead.created', { lead_id: lead.id, name: lead.name, phone: lead.phone, email: lead.email, source: lead.source });
    }
